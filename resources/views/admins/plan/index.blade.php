...
@section('content')
<div class="col-md-4">
@include('admins.plan.flash-message')
@include('admins.plan.create_form')
</div>
<div class="col-md-7">
<div class="row">
<div class="col-md-12">
            ...
            @foreach($plans as $plan)
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a class="red" href="{{ route('plan.delete', ['plan' => $plan->id]) }}"><i class="ace-icon fa fa-trash bigger-130"></i></a>
                        </div>
                        <div class=
                        "hidden-md hidden-lg">
                            <div class=
                            "inline pos-rel">
                                ...
                                <li>
                                    <a href="{{ route('control.plan.edit', ['plan' => $plan->id]) }}" title="Edit">
                                        <span class="green">
